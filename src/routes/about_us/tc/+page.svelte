<script>
    // You can add any script or reactive variables here if needed
</script>
<svelte:head>
...
<div class="min-h-screen flex items-center justify-center">
    <div class="text-center rounded-sm   w-11/12 max-w-2xl max-h-[80vh] overflow-y-auto p-8">
        <h1 class="text-2xl font-alexandria">Terms & Conditions</h1>
        <p class="mt-4 font-montserrat">Last updated on 14-06-2024 14:45:54</p>
        <p class="text-left font-montserrat mt-4">
            These Terms and Conditions, along with the privacy policy or other terms (“Terms”) constitute a binding
            agreement by and between MIHIR SANJAY YADAV (“Website Owner” or “we” or “us” or “our”) and
        ...
        <ul class="list-disc list-inside text-left font-montserrat mt-4">
            ...
            <li>All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Navi Mumbai, Maharashtra.</li>
...
<style>
    @import url('https://fonts.googleapis.com/css2?family=Alexandria&family=Montserrat:wght@400;700&display=swap');
